<?php
include_once('dc/include/config.php');
...
<head>
    ...
    <title> SmileCare Dental Home</title>
    ...
    <!--Header Starts Here--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:black;font-weight:bold; font-size:42px; margin-top: 1% !important;  margin-left: -10px">SmileCare
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    <img class="d-block w-100" src="slide.jpg" alt="Second slide">
                    <div class="carousel-cover" style="background-color: rgba(0, 49, 173, 0.53)"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown" style="color:black">SmileCare Dental Home</h5>
                ...
                <div class="carousel-item active">
                    <img class="d-block w-100" src="dentalchair.jpg" alt="Third slide">
                      <div class="carousel-cover"style="background-color: rgba(0, 49, 173, 0.53)"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown" style="color:black">SmileCare Dental Home</h5>
  ...
  <!--   Logins  -->
     ...
     <section id="logins" class="our-blog container-fluid">
        ...
        <div class="inner-title">
                ...
                <h2 style="color:#895129 ;font:28px">Logins</h2>
            </div>
                ...
                <div class="row no-margin">
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                                ...
                                <img src="patient.jpg" height="300" alt="">

                            <div class="blog-single-det">
                                <h6 style="color:#000; font-size:20px">Patient Login</h6>
                                <a href="dc/user-login.php" target="_blank">
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                                ...
                                <img src="dentish.jpg" height="300" alt="">

                            <div class="blog-single-det">
                                <h6 style="color:#000; font-size:20px">Doctors login</h6>
                                <a href="dc/doctor" target="_blank">
                                    <button class="btn btn-success btn-sm">Click Here</button>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                                ...
                                <img src="admin.png" height="300" alt="">

                            <div class="blog-single-det">
                                <h6 style="color:#000; font-size:20px">Admin Login</h6>
                                <a href="dc/admin" target="_blank">
                                    <button class="btn btn-success btn-sm">Click Here</button>
                                </a>
                            </div>
                        </div>
    ...
    <section id="services" class="key-features department">
        <div class="container">
            <div class="inner-title">
                ...
                <a href="services.php"><h2 style="color: #895129">Our Services</h2></a>
            ...
            <div class="row" style="color:black">
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                        <img src="bridge.png" height="100" alt="root_canal_treatment">
                        <h5>Crown & Bridge</h5>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                        <img src="x-ray.png" height="100" alt="root_canal_treatment">
                        <h5>Dental X-rays</h5>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                       <img src="root-canal.png" height="100" alt="root_canal_treatment">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                        <img src="dental.png" height="100" alt="root_canal_treatment">
                        <h5>Scaling</h5>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                        <img src="dental-surgery.png" height="100" alt="root_canal_treatment">
                        <h5>Surgery</h5>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                        <img src="extraction.png" height="100" alt="root_canal_treatment">
                        <h5>Extraction</h5>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                        <img src="dental-check.png" height="100" alt="root_canal_treatment">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                        <img src="dental-prosthesis.png" height="100" alt="root_canal_treatment">
                        <h5>Dental Prosthesis</h5>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                        <img src="implant.png" height="100">
    ...
    <section id="about_us" class="about-us">
        <div class="row no-margin">
            ...
            <div class="col-sm-6 abut-yoiu">
                ...
                <h3 style="color:#895129; font-size: 30px;">About Our Dental Home</h3>
<?php
    ...
    <section id="contact_us" class="contact-us-single">
        <div class="row no-margin">
            ...
            <div  class="col-sm-12 cop-ck">
                <form method="post">
                <h2 style="font-size: 28px; color:#895129" >Contact Form</h2>
                    <div class="row cf-ro">
...
?>
    ...
    <div class="copy">
            <div class="container" >
         SmileCare Dental Home(Solution to all your dental health problems)
